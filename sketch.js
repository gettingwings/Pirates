...
function setup() {
  ...
  slider.position(width-150,height-30)
...
function draw() {
  ...
  waterSound.setVolume( slider.value() );

  pirateLaughSound.setVolume(slider.value());
  cannonExplosion.setVolume(slider.value());
...
function showCannonBalls(ball, index) {
  ...
  if (ball) {
    ball.animate();
    ball.display();
    if(ball.body.position.x >= width+50 || ball.body.position.y >= height-60) {
